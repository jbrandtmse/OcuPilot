...
- Never add a design token, color, string-table entry, shell component, screen descriptor, port, installer step or CI workflow — those are Stories 1.2, 1.9, 1.10, 1.3/1.4 and 1.17.
