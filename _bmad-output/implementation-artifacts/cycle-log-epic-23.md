...
2026-09-26T16:46:34Z	Epic 23	integrate_forward	from=origin/feature/OCU-1_ocupilot-mvp@fe5b445e(11.11_merged) merge=62f506ac conflicts=sprint-status.yaml(theirs+regenerate),structural-baseline.json(ours:B4_emptied_DW-1584_keys_incl_2_new),tasks.browser-spec.mjs(combined:searchHistory+DEMO_TASK) verify=src_LoadDir_0_errors;Envelope_15/15;Smoke_40/40;TurnStream_6/6;Demo_12/12;test:tools_1483;test:components_109_files;build_initial_1.85MB(<1854kB);tasks.browser-spec_15/15;a11y-structural-invariants_12/12
2026-09-26T17:37:12Z	Story 23.1	ci_resolved	batch=B6+integrate_forward run=36256669284 head=677986fd result=success resolved_at=batch_boundary
2026-09-26T17:37:12Z	Story 23.1	committed	batch=B6 sha=677986fd code=e27ff3c4,ae40f16a,merge_62f506ac ci=success run=36256669284 amendments=spine_AD-42,deferred_DW-1650
2026-09-26T17:37:12Z	Story 23.1	batch_boundary_stop	reason=release_1.0.1_window_passed(feature_cut_at_11.11_merge_0148aac0) batches_done=L,B1,B2+B3,B4+B8,B6 batches_remaining=B5(9),B7(12+DW-1706) slice_range_end_cleanup=21 story_key_open=1(DW-1706) local_full_objectscript_sweep=not_run(final_dev_complete_not_reached;CI_instance_job_ran_full_suite_green_on_each_head)
