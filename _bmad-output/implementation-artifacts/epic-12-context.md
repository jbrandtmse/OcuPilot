...
- **Classic link-outs (AD-44).** The OAuth tabs hold Release 1's only `classicLinkExemption`, counted once. Story 12.4 removed the server-description tab's declaration; four tabs still declare it, and Story 12.9 removes them.
