...
| Task schedule | Tasks | side-bar › Task schedule | name, namespace, type, last run, next run; Task Manager status and control (a warning banner with Resume while it is suspended); filter; auto-refresh (FR-48) | list | 1/3 · P0 (control 4) |
